...
#line 742
typedef int (*__compar_fn_t)(const void *arg_0x2acf09054cf8, const void *arg_0x2acf09053020);
#line 780
__extension__ 
#line 797
__extension__ 
...
#line 250
extern double erfc(double arg_0x2acf090d5618) __attribute((__leaf__)) __attribute((__nothrow__)) ;
#line 326
__extension__ 
...
unsigned int (*hashfunction)(void *arg_0x2acf093168e8), 
int (*key_eq_fn)(void *arg_0x2acf093150c8, void *arg_0x2acf09315368));
#line 103
#line 102
int 
...
static inline void RandomInitialise(int arg_0x2acf09526610, int arg_0x2acf09526878);
static double RandomUniform(void );
...
# 9 "dataStructures/interfaces/../../protocol.h"
...
# 11 "dataStructures/interfaces/../../packet.h"
...
# 3 "lib/interfaces/PacketInfo.nc"
...
# 5 "lib/interfaces/ShortestPath.nc"
...
# 11 "lib/interfaces/Application.nc"
...
# 9 "lib/interfaces/Application.nc"
...
# 28 "lib/modules/ShortestPathC.nc"
...
# 11 "lib/interfaces/ShortestPath.nc"
...
# 19 "lib/modules/ApplicationC.nc"
...
# 9 "lib/interfaces/ShortestPath.nc"
...
#line 11
# 91 "lib/modules/ApplicationC.nc"
static inline error_t ApplicationC$Application$clientReady(void )
{
...
#line 199
  ...
  if (__nesc_ntoh_uint8(TransportC$recTCP[sim_node()]->dest_port.nxdata) != __nesc_ntoh_uint8(TransportC$nodeAddr[sim_node()].srcPort.nxdata)) 
    {
      sim_log_debug(241U, "Project3TGen", "Port not open\n");
      return FAIL;
    }
  ...
  switch (__nesc_ntoh_uint8(TransportC$recTCP[sim_node()]->flag.nxdata)) 
    {
        ...
        if (TransportC$sockSt[sim_node()].state == SOCK_LISTEN) 
          {
            ...
            sim_log_debug(243U, "Project3TGen", "Sent SYN_ACK, Pseq: %d, Aseq: %d\n", __nesc_ntoh_uint16(sendTCP->seq.nxdata), TransportC$sockSt[sim_node()].seq);
      ...
      case SYN_ACK: 
        sim_log_debug(244U, "Project3TGen", "Received SYN_ACK from node %d at port %d\n", __nesc_ntoh_uint16(package->src.nxdata), __nesc_ntoh_uint8(TransportC$recTCP[sim_node()]->dest_port.nxdata));
      ...
      if (TransportC$sockSt[sim_node()].state == SOCK_SYN_SENT) 
        {
          ...
          sim_log_debug(245U, "Project3TGen", "Connection Established\n");

          TransportC$sendSignal(TransportC$sock[sim_node()]);
          TransportC$sockSt[sim_node()].packet = TransportC$sendPackage[sim_node()];
          sim_log_debug(246U, "Project3TGen", "Sent ACK, Pseq: %d, Aseq: %d\n", __nesc_ntoh_uint16(sendTCP->seq.nxdata), TransportC$sockSt[sim_node()].seq);
        ...
        if (TransportC$sockSt[sim_node()].state == SOCK_ESTABLISHED) 
          {
            ...
            sim_log_debug(247U, "Project3TGen", "Sent ACK, Pseq: %d, Aseq: %d\n", __nesc_ntoh_uint16(sendTCP->seq.nxdata), TransportC$sockSt[sim_node()].seq - 1);
          }
        }
#line 305
      break;
      ...
      case ACK: 
        sim_log_debug(248U, "Project3TGen", "Received ACK from node %d at port %d\n", __nesc_ntoh_uint16(package->src.nxdata), __nesc_ntoh_uint8(TransportC$recTCP[sim_node()]->dest_port.nxdata));
        ...
        if (TransportC$sockSt[sim_node()].state == SOCK_SYN_RCVD) 
          {
            ...
            sim_log_debug(249U, "Project3TGen", "Connection Established, seq: %d\n", __nesc_ntoh_uint16(TransportC$recTCP[sim_node()]->seq.nxdata));
          }
        else {
#line 324
          if (TransportC$sockSt[sim_node()].state == SOCK_LAST_ACK) 
            {
              ...
              sim_log_debug(250U, "Project3TGen", "Connection Closed\n");
            }
          }
        }
#line 335
      ...
      case FIN: 
        sim_log_debug(251U, "Project3TGen", "Received FIN from node %d at port %d\n", __nesc_ntoh_uint16(package->src.nxdata), __nesc_ntoh_uint8(TransportC$recTCP[sim_node()]->dest_port.nxdata));
      ...
      if (TransportC$sockSt[sim_node()].state == SOCK_ESTABLISHED) 
        {
          ...
          sim_log_debug(252U, "Project3TGen", "Sent FIN\n");
          TransportC$sockSt[sim_node()].seq++;
        ...
        if (TransportC$sockSt[sim_node()].state == SOCK_FIN_WAIT) 
          {
            ...
            sim_log_debug(253U, "Project3TGen", "Sent ACK\n");
            TransportC$sockSt[sim_node()].seq++;
...
# 85 "lib/interfaces/Transport.nc"
...
#line 4
# 56 "lib/modules/FloodingC.nc"
static inline void FloodingC$broadcastMsg(pack *msg)
{
  sim_log_debug(218U, "Project1F", "Broadcasting...\n");
...
static inline void FloodingC$printMsg(pack *msg)
{
  sim_log_debug(216U, "Project1F", "Delivered from node: %d\n", (uint16_t )__nesc_ntoh_uint16(msg->src.nxdata));
  sim_log_debug(217U, "genDebug", "Packet Payload: %s\n", msg->payload);
}
...
#line 20
# 81 "dataStructures/modules/ListC.nc"
static inline uint16_t /*NodeC.recPackets*/ListC$2$List$size(void )
#line 81
{
...
#line 24
# 85 "dataStructures/modules/ListC.nc"
static inline /*NodeC.recPackets*/ListC$2$t /*NodeC.recPackets*/ListC$2$List$get(uint16_t position)
#line 85
{
  ...
  for (FloodingC$i[sim_node()] = 0; FloodingC$i[sim_node()] < FloodingC$recPackets$size(); FloodingC$i[sim_node()]++) 
    {
      ...
      if (seq == FloodingC$newpackid[sim_node()].sequence && src == FloodingC$newpackid[sim_node()].moteID) 
        {
          sim_log_debug(215U, "Project1F", "Already received packet!\n");
          return TRUE;
        }
    }
...
static inline uint16_t FloodingC$Flooding$receive(pack *myMsg)
{
  sim_log_debug(219U, "Project1F", "Packet Received\n");
...
#line 17
# 89 "dataStructures/modules/ListC.nc"
static inline void /*NodeC.NeighborLS*/ListC$1$List$set(uint16_t position, /*NodeC.NeighborLS*/ListC$1$t input)
{
...
#line 24
# 74 "dataStructures/modules/ListC.nc"
static inline bool /*NodeC.NeighborLS*/ListC$1$List$isEmpty(void )
#line 74
{
...
#line 92
# 23 "dataStructures/modules/ListC.nc"
static inline void /*NodeC.Neighbors*/ListC$0$List$pushback(/*NodeC.Neighbors*/ListC$0$t input)
#line 23
{
...
# 5 "lib/interfaces/PacketInfo.nc"
...
#line 481
  ...
  if (TransportC$sockSt[sim_node()].state != SOCK_ESTABLISHED) 
    {
      sim_log_debug(256U, "Project3TGen", "Nothing to close\n");
      return FAIL;
    }
  ...
  TransportC$sockSt[sim_node()].packet = TransportC$sendPackage[sim_node()];
  sim_log_debug(257U, "Project3TGen", "Sent FIN\n");
...
#line 14
# 98 "lib/modules/ApplicationC.nc"
static inline error_t ApplicationC$Application$serverReady(void )
{
  ApplicationC$ReadTimer$startOneShot(27707);

  return SUCCESS;
}

# 517 "lib/modules/TransportC.nc"
static inline error_t TransportC$Transport$listen(socket_t fd)
{
  if (!TransportC$Sockets$contains(fd)) 
    {
...
#line 30
# 26 "lib/modules/ApplicationC.nc"
static inline error_t ApplicationC$Application$initializeServer(uint8_t server_port)
{
  ...
  for (ApplicationC$i[sim_node()] = 0; ApplicationC$i[sim_node()] < SOCKET_SEND_BUFFER_SIZE; ApplicationC$i[sim_node()]++) 
    {
      ApplicationC$sockSt[sim_node()].recBuff[ApplicationC$i[sim_node()]] = -1;
      ApplicationC$sockSt[sim_node()].sendBuff[ApplicationC$i[sim_node()]] = -1;
    }
...
# 7 "lib/interfaces/Application.nc"
...
#line 453
  ...
  TransportC$sendSignal(fd);
  TransportC$sockSt[sim_node()].packet = TransportC$sendPackage[sim_node()];
  sim_log_debug(255U, "Project3TGen", "Sent SYN, Pseq: %d, Aseq: %d\n", __nesc_ntoh_uint16(sendTCP->seq.nxdata), TransportC$sockSt[sim_node()].seq);
...
#line 116
# 52 "lib/modules/ApplicationC.nc"
static inline error_t ApplicationC$Application$initializeClient(uint8_t client_port, uint8_t dest_addr, uint8_t dest_port, uint16_t transfer)
{
  uint16_t index;
  ...
  if (ApplicationC$Transport$bind(ApplicationC$fd[sim_node()], &ApplicationC$addr[sim_node()]) == SUCCESS) 
    {
      ...
      for (ApplicationC$i[sim_node()] = 0; ApplicationC$i[sim_node()] < transfer / 2; ApplicationC$i[sim_node()]++) 
        {
          ApplicationC$sockSt[sim_node()].dataToSend[index] = (ApplicationC$i[sim_node()] + 1) >> 8;
          ApplicationC$sockSt[sim_node()].dataToSend[index + 1] = (ApplicationC$i[sim_node()] + 1) & 0x00ff;
          index += 2;
        }

      ApplicationC$sockSt[sim_node()].dataToSendSize = transfer;
      ApplicationC$sockSt[sim_node()].sendBuffSize = 0;
      ApplicationC$sockSt[sim_node()].recBuffSize = 0;
...
#line 14
# 146 "dataStructures/modules/HashmapC.nc"
static inline uint16_t /*NodeC.ConfirmedNodes*/HashmapC$1$Hashmap$size(void )
#line 146
{
...
#line 18
# 142 "dataStructures/modules/HashmapC.nc"
static inline uint32_t */*NodeC.ConfirmedNodes*/HashmapC$1$Hashmap$getKeys(void )
#line 142
{
...
# 19 "dataStructures/interfaces/Hashmap.nc"
...
#line 19
# 169 "lib/modules/ShortestPathC.nc"
static inline error_t ShortestPathC$ShortestPath$PrintRoutingTable(void )
{
  ShortestPathC$keys[sim_node()] = ShortestPathC$ConfirmedNodes$getKeys();

  sim_log_debug(223U, "Project2", "---- %d's Routing Table ----\n", (uint16_t )TOS_NODE_ID);
  sim_log_debug(224U, "Project2", "(node, cost, next-hop)\n");
...
#line 10
# 101 "lib/modules/NeighborC.nc"
static inline error_t NeighborC$Neighbor$print(void )
{
  sim_log_debug(210U, "Project1N", "Neighbors:\n");
  for (NeighborC$i[sim_node()] = 0; NeighborC$i[sim_node()] < NeighborC$Neighbors$size(); NeighborC$i[sim_node()]++) 
    {
      NeighborC$newtuple[sim_node()] = NeighborC$Neighbors$get(NeighborC$i[sim_node()]);
      sim_log_debug(211U, "Project1N", "Node %d\n", (uint16_t )__nesc_ntoh_uint16(NeighborC$newtuple[sim_node()].mote.nxdata));
    }
...
#line 48
            if (commandID == CMD_TEST_SERVER) {
                sim_log_debug(207U, "cmdDebug", "Command Type: Test Server\n");
...
#line 52
              if (commandID == CMD_KILL) {
                  sim_log_debug(208U, "cmdDebug", "Command Type: Close Client\n");
...
# 78 "/home/luis/local/tinyos-2.1.1/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Receive$receive(am_id_t arg_0x2acf09927340, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
  switch (arg_0x2acf09927340) {
#line 78
    case 6:
#line 78
...
#line 78
    default:
#line 78
      __nesc_result = TossimActiveMessageC$Receive$default$receive(arg_0x2acf09927340, msg, payload, len);
#line 78
      break;
#line 78
    }
...
#line 52
# 30 "dataStructures/modules/HashmapC.nc"
static inline uint32_t /*NodeC.Sockets*/HashmapC$2$hash3(uint32_t k)
#line 30
{
  return 1 + k % 11;
...
# 78 "/home/luis/local/tinyos-2.1.1/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Snoop$receive(am_id_t arg_0x2acf09956020, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
    __nesc_result = TossimActiveMessageC$Snoop$default$receive(arg_0x2acf09956020, msg, payload, len);
#line 78
...
# 110 "/home/luis/local/tinyos-2.1.1/tos/interfaces/AMSend.nc"
inline static void TossimActiveMessageC$AMSend$sendDone(am_id_t arg_0x2acf09929220, message_t * msg, error_t error){
#line 110
  /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$sendDone(arg_0x2acf09929220, msg, error);
#line 110
}
#line 110
...
#line 81
# 80 "/home/luis/local/tinyos-2.1.1/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$send(am_id_t arg_0x2acf09f0a488, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = TossimActiveMessageC$AMSend$send(arg_0x2acf09f0a488, addr, msg, len);
#line 80
...
# 109 "lib/modules/SimpleSendP.nc"
static inline void SimpleSendP$AMSend$sendDone(message_t *msg, error_t error)
#line 109
{
...
# 100 "/home/luis/local/tinyos-2.1.1/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$sendDone(uint8_t arg_0x2acf09f0b318, message_t * msg, error_t error){
#line 100
  switch (arg_0x2acf09f0b318) {
#line 100
    case 0U:
#line 100
...
#line 100
    default:
#line 100
      /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$default$sendDone(arg_0x2acf09f0b318, msg, error);
#line 100
      break;
#line 100
    }
...
# 75 "/home/luis/local/tinyos-2.1.1/tos/interfaces/TaskBasic.nc"
inline static void SimSchedulerBasicP$TaskBasic$runTask(uint8_t arg_0x2acf09627108){
#line 75
  switch (arg_0x2acf09627108) {
#line 75
...
#line 75
    default:
#line 75
      SimSchedulerBasicP$TaskBasic$default$runTask(arg_0x2acf09627108);
#line 75
      break;
#line 75
    }
...
#line 19
# 136 "dataStructures/modules/HashmapC.nc"
static inline bool /*NodeC.Tentative*/HashmapC$0$Hashmap$isEmpty(void )
#line 136
{
...
#line 16
# 90 "dataStructures/modules/HashmapC.nc"
static inline void /*NodeC.ConfirmedNodes*/HashmapC$1$Hashmap$clear(void )
#line 90
{
  uint32_t i = 0;
...
#line 13
# 64 "lib/modules/ShortestPathC.nc"
static inline error_t ShortestPathC$ShortestPath$Dijkstra(void )
{
      ...
      if (TransportC$sockSt[sim_node()].state == SOCK_TIME_WAIT && TransportC$sockSt[sim_node()].inAckTimeOut == TRUE) 
        {
          ...
          if (TransportC$sockSt[sim_node()].state == SOCK_TIME_WAIT && (TransportC$sockSt[sim_node()].acktimeOut == 0 || TransportC$sockSt[sim_node()].acktimeOut > 60000)) 
            {
              sim_log_debug(258U, "Project3TGen", "Connection Closed\n");
...
# 75 "lib/interfaces/Transport.nc"
...
#line 19
# 105 "lib/modules/ApplicationC.nc"
static inline void ApplicationC$TryWritingTimer$fired(void )
{
  uint32_t *keys;
...
# 102 "lib/interfaces/Transport.nc"
...
#line 102
# 124 "lib/modules/ApplicationC.nc"
static inline void ApplicationC$ReadTimer$fired(void )
{
  uint16_t j;
#line 126
  ...
  for (ApplicationC$i[sim_node()] = 0; ApplicationC$i[sim_node()] < ApplicationC$Sockets$size(); ApplicationC$i[sim_node()]++) 
    {
      ...
      if (tmp1 > tmp2 && ApplicationC$sockSt[sim_node()].state == SOCK_ESTABLISHED) 
        {
          ApplicationC$readBuffSize[sim_node()] = ApplicationC$Transport$read(keys[ApplicationC$i[sim_node()]], ApplicationC$readBuffer[sim_node()], READ_BUFFER_MAX - ApplicationC$readBuffSize[sim_node()]);

          mod20 = ApplicationC$readBuffSize[sim_node()] % 20;
          for (j = 0; j < ApplicationC$readBuffSize[sim_node()] - mod20; j += 20) 
            {
              lower1 = ApplicationC$readBuffer[sim_node()][j] << 8;
#line 146
              upper1 = lower1 | ApplicationC$readBuffer[sim_node()][j + 1];
              lower2 = ApplicationC$readBuffer[sim_node()][j + 2] << 8;
#line 147
              upper2 = lower2 | ApplicationC$readBuffer[sim_node()][j + 3];
              lower3 = ApplicationC$readBuffer[sim_node()][j + 4] << 8;
#line 148
              upper3 = lower3 | ApplicationC$readBuffer[sim_node()][j + 5];
              lower4 = ApplicationC$readBuffer[sim_node()][j + 6] << 8;
#line 149
              upper4 = lower4 | ApplicationC$readBuffer[sim_node()][j + 7];
              lower5 = ApplicationC$readBuffer[sim_node()][j + 8] << 8;
#line 150
              upper5 = lower5 | ApplicationC$readBuffer[sim_node()][j + 9];
              lower6 = ApplicationC$readBuffer[sim_node()][j + 10] << 8;
#line 151
              upper6 = lower6 | ApplicationC$readBuffer[sim_node()][j + 11];
              lower7 = ApplicationC$readBuffer[sim_node()][j + 12] << 8;
#line 152
              upper7 = lower7 | ApplicationC$readBuffer[sim_node()][j + 13];
              lower8 = ApplicationC$readBuffer[sim_node()][j + 14] << 8;
#line 153
              upper8 = lower8 | ApplicationC$readBuffer[sim_node()][j + 15];
              lower9 = ApplicationC$readBuffer[sim_node()][j + 16] << 8;
#line 154
              upper9 = lower9 | ApplicationC$readBuffer[sim_node()][j + 17];
              lower10 = ApplicationC$readBuffer[sim_node()][j + 18] << 8;
#line 155
              upper10 = lower10 | ApplicationC$readBuffer[sim_node()][j + 19];

              sim_log_debug(269U, "Project3TGen", "Data %d: %d, %d, %d, %d, %d, %d, %d, %d, %d, %d\n", __nesc_ntoh_uint8(ApplicationC$sockSt[sim_node()].sockAddr.destPort.nxdata), upper1, upper2, upper3, upper4, upper5, upper6, upper7, upper8, upper9, upper10);
            }
          if (mod20 == 18) 
            {
              index = ApplicationC$readBuffSize[sim_node()] - mod20;
              lower1 = ApplicationC$readBuffer[sim_node()][index] << 8;
#line 162
              upper1 = lower1 | ApplicationC$readBuffer[sim_node()][index + 1];
              lower2 = ApplicationC$readBuffer[sim_node()][index + 2] << 8;
#line 163
              upper2 = lower2 | ApplicationC$readBuffer[sim_node()][index + 3];
              lower3 = ApplicationC$readBuffer[sim_node()][index + 4] << 8;
#line 164
              upper3 = lower3 | ApplicationC$readBuffer[sim_node()][index + 5];
              lower4 = ApplicationC$readBuffer[sim_node()][index + 6] << 8;
#line 165
              upper4 = lower4 | ApplicationC$readBuffer[sim_node()][index + 7];
              lower5 = ApplicationC$readBuffer[sim_node()][index + 8] << 8;
#line 166
              upper5 = lower5 | ApplicationC$readBuffer[sim_node()][index + 9];
              lower6 = ApplicationC$readBuffer[sim_node()][index + 10] << 8;
#line 167
              upper6 = lower6 | ApplicationC$readBuffer[sim_node()][index + 11];
              lower7 = ApplicationC$readBuffer[sim_node()][index + 12] << 8;
#line 168
              upper7 = lower7 | ApplicationC$readBuffer[sim_node()][index + 13];
              lower8 = ApplicationC$readBuffer[sim_node()][index + 14] << 8;
#line 169
              upper8 = lower8 | ApplicationC$readBuffer[sim_node()][index + 15];
              lower9 = ApplicationC$readBuffer[sim_node()][index + 16] << 8;
#line 170
              upper9 = lower9 | ApplicationC$readBuffer[sim_node()][index + 17];

              sim_log_debug(270U, "Project3TGen", "Data %d: %d, %d, %d, %d, %d, %d, %d, %d, %d\n", __nesc_ntoh_uint8(ApplicationC$sockSt[sim_node()].sockAddr.destPort.nxdata), upper1, upper2, upper3, upper4, upper5, upper6, upper7, upper8, upper9);
            }
          if (mod20 == 16) 
            {
              index = ApplicationC$readBuffSize[sim_node()] - mod20;
...
#line 184
              ...
              sim_log_debug(271U, "Project3TGen", "Data %d: %d, %d, %d, %d, %d, %d, %d, %d\n", __nesc_ntoh_uint8(ApplicationC$sockSt[sim_node()].sockAddr.destPort.nxdata), upper1, upper2, upper3, upper4, upper5, upper6, upper7, upper8);
            }
          if (mod20 == 14) 
            {
              index = ApplicationC$readBuffSize[sim_node()] - mod20;
...
#line 197
              ...
              sim_log_debug(272U, "Project3TGen", "Data %d: %d, %d, %d, %d, %d, %d, %d\n", __nesc_ntoh_uint8(ApplicationC$sockSt[sim_node()].sockAddr.destPort.nxdata), upper1, upper2, upper3, upper4, upper5, upper6, upper7);
            }
          if (mod20 == 12) 
            {
              index = ApplicationC$readBuffSize[sim_node()] - mod20;
...
#line 209
              ...
              sim_log_debug(273U, "Project3TGen", "Data %d: %d, %d, %d, %d, %d, %d\n", __nesc_ntoh_uint8(ApplicationC$sockSt[sim_node()].sockAddr.destPort.nxdata), upper1, upper2, upper3, upper4, upper5, upper6);
            }
          if (mod20 == 10) 
            {
              index = ApplicationC$readBuffSize[sim_node()] - mod20;
...
#line 220
              ...
              sim_log_debug(274U, "Project3TGen", "Data %d: %d, %d, %d, %d, %d\n", __nesc_ntoh_uint8(ApplicationC$sockSt[sim_node()].sockAddr.destPort.nxdata), upper1, upper2, upper3, upper4, upper5);
            }
          if (mod20 == 8) 
            {
              index = ApplicationC$readBuffSize[sim_node()] - mod20;
...
#line 230
              ...
              sim_log_debug(275U, "Project3TGen", "Data %d: %d, %d, %d, %d\n", __nesc_ntoh_uint8(ApplicationC$sockSt[sim_node()].sockAddr.destPort.nxdata), upper1, upper2, upper3, upper4);
            }
          if (mod20 == 6) 
            {
              index = ApplicationC$readBuffSize[sim_node()] - mod20;
...
#line 239
              ...
              sim_log_debug(276U, "Project3TGen", "Data %d: %d, %d, %d\n", __nesc_ntoh_uint8(ApplicationC$sockSt[sim_node()].sockAddr.destPort.nxdata), upper1, upper2, upper3);
            }
          if (mod20 == 4) 
            {
              index = ApplicationC$readBuffSize[sim_node()] - mod20;
...
#line 247
              ...
              sim_log_debug(277U, "Project3TGen", "Data %d: %d, %d\n", __nesc_ntoh_uint8(ApplicationC$sockSt[sim_node()].sockAddr.destPort.nxdata), upper1, upper2);
            }
          if (mod20 == 2) 
            {
              index = ApplicationC$readBuffSize[sim_node()] - mod20;
...
#line 254
              ...
              sim_log_debug(278U, "Project3TGen", "Data %d: %d\n", __nesc_ntoh_uint8(ApplicationC$sockSt[sim_node()].sockAddr.destPort.nxdata), upper1);
            }
...
# 83 "/home/luis/local/tinyos-2.1.1/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$fired(uint8_t arg_0x2acf09df8c28){
#line 83
  switch (arg_0x2acf09df8c28) {
#line 83
    case 0U:
#line 83
...
#line 83
    default:
#line 83
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$default$fired(arg_0x2acf09df8c28);
#line 83
      break;
#line 83
    }
...
# 241 "lib/modules/ShortestPathC.nc"
static error_t ShortestPathC$ShortestPath$SendPack(pack *myMsg)
{
...
# 102 "dataStructures/modules/HashmapC.nc"
static /*NodeC.ConfirmedNodes*/HashmapC$1$t /*NodeC.ConfirmedNodes*/HashmapC$1$Hashmap$get(uint32_t k)
#line 102
{
  uint32_t i = 0;
...
# 187 "lib/modules/ShortestPathC.nc"
static error_t ShortestPathC$ShortestPath$RoutePack(pack *myMsg)
{
  if (__nesc_ntoh_uint16(myMsg->dest.nxdata) == TOS_NODE_ID) 
    {
...
#line 219
        if (ShortestPathC$checkSequences(__nesc_ntoh_uint16(myMsg->seq.nxdata), __nesc_ntoh_uint16(myMsg->src.nxdata)) == TRUE) 
          {
            if (!strcmp((char *)myMsg->payload, "ACKNOWLEDGEMENT")) 
              {
                sim_log_debug(227U, "Project2", "Received ACK\n");
                return SUCCESS;
              }
  ...
  sim_log_debug(228U, "Project2", "Sending to: %d, Next Hop: %d\n", __nesc_ntoh_uint16(myMsg->dest.nxdata), ShortestPathC$route[sim_node()].nextHop);
  ShortestPathC$Sender$send(*myMsg, ShortestPathC$route[sim_node()].nextHop);
  ...
  for (ShortestPathC$i[sim_node()] = 0; ShortestPathC$i[sim_node()] < ShortestPathC$recPackets$size(); ShortestPathC$i[sim_node()]++) 
    {
      ...
      if (seq == ShortestPathC$newpackid[sim_node()].sequence && src == ShortestPathC$newpackid[sim_node()].moteID) 
        {
          sim_log_debug(220U, "Project1F", "Already received packet!\n");
          return TRUE;
        }
    }
...
# 50 "dataStructures/modules/ListC.nc"
static /*NodeC.recPackets*/ListC$2$t /*NodeC.recPackets*/ListC$2$List$popfront(void )
#line 50
{
...
# 58 "lib/modules/ShortestPathC.nc"
static void ShortestPathC$printMsg(pack *msg)
{
  sim_log_debug(221U, "Project2", "Delivered from node: %d\n", (uint16_t )__nesc_ntoh_uint16(msg->src.nxdata));
  sim_log_debug(222U, "Project2", "Packet Payload: %s\n", msg->payload);
}
...
static socket_t TransportC$Transport$socket(void )
{
  ...
  sim_log_debug(240U, "Project3TGen", "No available sockets...\n");
  return -1;
}

# 125 "dataStructures/modules/HashmapC.nc"
static bool /*NodeC.Sockets*/HashmapC$2$Hashmap$contains(uint32_t k)
#line 125
{
  uint32_t i = 0;
...
#line 73
# 38 "dataStructures/modules/HashmapC.nc"
static void /*NodeC.ConfirmedNodes*/HashmapC$1$Hashmap$insert(uint32_t k, /*NodeC.ConfirmedNodes*/HashmapC$1$t input)
#line 38
{
  uint32_t i = 0;
